...
namespace Lacobus.BehaviourTreeEditor
{
    public class BehaviourTreeEditor : EditorWindow
    {
        ...
        [MenuItem("Lacobus/Behaviour Tree/Open graph editor...")]
        ...
        public void CreateGUI()
        {
            ...
            // Import Uxml
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Lacobus - Behaviour Tree/Scripts/UIBuilder/BehaviourTreeEditor.uxml");
